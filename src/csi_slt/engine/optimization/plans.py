...
# Deliberately the same seven names ``SltTrainabilityPlan`` uses: a component
# is the unit that owns parameters, and the two plans must agree on that
# ownership or an override could target a set of parameters the trainability
# plan never unfroze.
