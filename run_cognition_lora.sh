...
CMD_ARGS=(
  ...
  engine.training_args.output_dir=outputs/v4.0-qwen3-1.7b-cradio-l-dinoframecrossv28shuffle-0827.224x224-ctc-de-cpt-vlora-last4-qkv-r8-adapter-ft
  ...
  engine.training_args.learning_rate=1e-5
