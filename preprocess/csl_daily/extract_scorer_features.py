...
Usage::
    ...
    python preprocess/csl_daily/extract_scorer_features.py
    ...
    python preprocess/csl_daily/extract_scorer_features.py \
        ...
        --out dataset/CSL-Daily-HG/preprocessed/scorer_features_L8

    # smoke test: 128 frames per split, marked truncated in meta.json
    python preprocess/csl_daily/extract_scorer_features.py --limit-frames 128 --out /tmp/check

The frame dataset comes from ``preprocess/csl_daily/build_scorer_dataset.py``;
...
Output::
    ...
    dataset/CSL-Daily-HG/preprocessed/scorer_features/
...
def main():
    ...
    if not dataset_info_path.exists():
        raise FileNotFoundError(
            ...
            "preprocess/csl_daily/build_scorer_dataset.py"
        )
