...
Usage::
    ...
    python preprocess/ph14t/build_scorer_dataset.py --dry-run

    # build it: ~13.7k frames, a few minutes across --workers processes
    python preprocess/ph14t/build_scorer_dataset.py --out dataset/ph14_train_scorer_dataset

    # a bigger fitting set: raise the per-signer frame budget
    python preprocess/ph14t/build_scorer_dataset.py --frames-per-signer 2500
