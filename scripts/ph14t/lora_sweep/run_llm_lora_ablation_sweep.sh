#! /bin/bash
#
# Sweep wrapper for scripts/ph14t/run_llm_lora_ablation.sh.
#
...
#
# Usage:
#   bash scripts/ph14t/lora_sweep/run_llm_lora_ablation_sweep.sh             # run sequentially
#   bash scripts/ph14t/lora_sweep/run_llm_lora_ablation_sweep.sh --sbatch    # submit to Slurm
#   bash scripts/ph14t/lora_sweep/run_llm_lora_ablation_sweep.sh --dry-run   # preview only
#
# Environment overrides (space-separated lists):
#   TARGETS="qv qkvo" RANKS="8 16" EPOCHS=20 \
#     bash scripts/ph14t/lora_sweep/run_llm_lora_ablation_sweep.sh
#
