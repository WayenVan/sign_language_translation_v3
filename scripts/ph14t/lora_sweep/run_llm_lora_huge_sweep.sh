...
#
# Usage:
#   bash scripts/ph14t/lora_sweep/run_llm_lora_huge_sweep.sh             # run sequentially
#   bash scripts/ph14t/lora_sweep/run_llm_lora_huge_sweep.sh --sbatch    # submit to Slurm
#   bash scripts/ph14t/lora_sweep/run_llm_lora_huge_sweep.sh --dry-run   # preview only
#
# Environment overrides:
#   RANKS="256 512" EPOCHS=20 \
#     bash scripts/ph14t/lora_sweep/run_llm_lora_huge_sweep.sh
#
# Optional child flags:
#   EXTRA_ARGS="share"  (or "debug share" when running the child directly)
#
# Huge-rank qkvo sweep wrapper for scripts/ph14t/run_llm_lora_ablation.sh.
#
# Sweep dimension:
