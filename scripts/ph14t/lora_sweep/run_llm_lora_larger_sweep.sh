#! /bin/bash
#
# Larger-rank qkvo sweep wrapper for scripts/ph14t/run_llm_lora_ablation.sh.
#
# Sweep dimension:
...
#
# Usage:
#   bash scripts/ph14t/lora_sweep/run_llm_lora_larger_sweep.sh             # run sequentially
#   bash scripts/ph14t/lora_sweep/run_llm_lora_larger_sweep.sh --sbatch    # submit to Slurm
#   bash scripts/ph14t/lora_sweep/run_llm_lora_larger_sweep.sh --dry-run   # preview only
#
# Environment overrides:
#   RANKS="32 64 128" EPOCHS=20 \
#     bash scripts/ph14t/lora_sweep/run_llm_lora_larger_sweep.sh
#
