...
#
# Usage:
#   bash scripts/ph14t/eval/run_eval_cf_last_prompt.sh <CKPT_DIR>          # 2 variants
#   bash scripts/ph14t/eval/run_eval_cf_last_prompt.sh <CKPT_DIR> share    # in-repo dataset
#   bash scripts/ph14t/eval/run_eval_cf_last_prompt.sh <CKPT_DIR> dry-run  # preview only
#
...
#
# Help: scripts/ph14t/eval/run_eval_cf_last_prompt.sh --help
#
