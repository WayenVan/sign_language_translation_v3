...
#
# Usage:
#   bash scripts/ph14t/eval/run_eval_unseen_prompt.sh <CKPT_DIR>          # 8 variants
#   bash scripts/ph14t/eval/run_eval_unseen_prompt.sh <CKPT_DIR> share    # in-repo dataset
#   bash scripts/ph14t/eval/run_eval_unseen_prompt.sh <CKPT_DIR> dry-run  # preview only
#
...
#
# Help: scripts/ph14t/eval/run_eval_unseen_prompt.sh --help
#
