...
#
# Usage:
#   bash scripts/ph14t/eval/run_eval_fixed_prompt.sh <CKPT_DIR>              # de+en+zh, canonical prompt
#   bash scripts/ph14t/eval/run_eval_fixed_prompt.sh <CKPT_DIR> de           # one target language
#   bash scripts/ph14t/eval/run_eval_fixed_prompt.sh <CKPT_DIR> multi share  # in-repo dataset
#   bash scripts/ph14t/eval/run_eval_fixed_prompt.sh <CKPT_DIR> dry-run      # preview only
#
...
#
# Help: scripts/ph14t/eval/run_eval_fixed_prompt.sh --help
#
