...
#
# Usage:
#   bash scripts/ph14t/eval/sweep4b/run_multilang_unseen_sweep.sh            # 已跑完 diverse 的每个 ckpt
#   bash scripts/ph14t/eval/sweep4b/run_multilang_unseen_sweep.sh share      # 用仓库内数据集
#   bash scripts/ph14t/eval/sweep4b/run_multilang_unseen_sweep.sh dry-run    # 只打印命令
#
# Environment:
...
#
# Help: scripts/ph14t/eval/sweep4b/run_multilang_unseen_sweep.sh --help
#
