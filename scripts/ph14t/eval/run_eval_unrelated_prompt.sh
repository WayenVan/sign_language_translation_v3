...
#
# Usage:
#   bash scripts/ph14t/eval/run_eval_unrelated_prompt.sh <CKPT_DIR>          # 1 variant
#   bash scripts/ph14t/eval/run_eval_unrelated_prompt.sh <CKPT_DIR> share    # in-repo dataset
#   bash scripts/ph14t/eval/run_eval_unrelated_prompt.sh <CKPT_DIR> dry-run  # preview only
#
...
#
# Help: scripts/ph14t/eval/run_eval_unrelated_prompt.sh --help
#
