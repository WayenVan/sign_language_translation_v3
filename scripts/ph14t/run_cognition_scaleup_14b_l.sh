...
#
# Usage:
#   sbatch scripts/ph14t/run_cognition_scaleup_14b_l.sh                # de, fixed prompt (default)
#   sbatch scripts/ph14t/run_cognition_scaleup_14b_l.sh en             # single target language: de | en | zh
#   sbatch scripts/ph14t/run_cognition_scaleup_14b_l.sh multi          # multilingual joint training (de+en+zh)
#   sbatch scripts/ph14t/run_cognition_scaleup_14b_l.sh multi diverse  # joint training with diverse train prompts
#   sbatch scripts/ph14t/run_cognition_scaleup_14b_l.sh multi 60       # override the epoch count
#   sbatch scripts/ph14t/run_cognition_scaleup_14b_l.sh de share       # shared dataset path, no scratch staging
#   sbatch scripts/ph14t/run_cognition_scaleup_14b_l.sh debug          # no WandB; outputs/debug-scaleup-14b-l-<tag>
#
...
#
# The overrides below are scripts/ph14t/run_cognition_target_language.sh's, changed
