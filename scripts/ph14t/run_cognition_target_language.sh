...
#
#   sbatch scripts/ph14t/run_cognition_target_language.sh
#   sbatch scripts/ph14t/run_cognition_target_language.sh zh
#   sbatch scripts/ph14t/run_cognition_target_language.sh de share
# --------------------------------------------------------------------------- #
