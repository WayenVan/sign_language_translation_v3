...
# =========================================================================== #
# USAGE
#   sbatch [-J JOB_NAME] scripts/ph14t/run_llm_lora_ablation.sh [TARGETS] [RANK] [EPOCHS] [debug] [share]
#   bash scripts/ph14t/run_llm_lora_ablation.sh [TARGETS] [RANK] [EPOCHS] [debug] [share]
#
# TARGETS: qv or qkvo. Defaults: qv, RANK=8, ALPHA=2*RANK, all 36 layers,
# LR=1e-4, EPOCHS=config (12).
# Example:  sbatch -J slt_llora_qkvo_r8 scripts/ph14t/run_llm_lora_ablation.sh qkvo 8
...
# Help:     scripts/ph14t/run_llm_lora_ablation.sh --help
# =========================================================================== #
...
#
# Examples:
#   sbatch -J slt_llora_qv_r8       scripts/ph14t/run_llm_lora_ablation.sh qv 8
#   sbatch -J slt_llora_qkvo_r16    scripts/ph14t/run_llm_lora_ablation.sh qkvo 16
#   sbatch -J slt_llora_qv_r8_ep20  scripts/ph14t/run_llm_lora_ablation.sh qv 8 20
#   bash scripts/ph14t/run_llm_lora_ablation.sh qkvo 8 debug share
# --------------------------------------------------------------------------- #
