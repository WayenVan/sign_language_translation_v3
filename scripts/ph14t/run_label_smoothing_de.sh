...
# Host handling, mirrored from scripts/ph14t/run_visual_lora_ablation.sh: force
...
#
#   scripts/ph14t/run_cognition_target_language.sh de
#
...
#
# Usage:
#   sbatch scripts/ph14t/run_label_smoothing_de.sh                 # off (eps = 0.0)
#   sbatch scripts/ph14t/run_label_smoothing_de.sh smooth          # on,  eps = 0.1
#   sbatch scripts/ph14t/run_label_smoothing_de.sh smooth=0.05     # on,  eps = 0.05
#   sbatch scripts/ph14t/run_label_smoothing_de.sh smooth debug
#   sbatch scripts/ph14t/run_label_smoothing_de.sh smooth share
# --------------------------------------------------------------------------- #
...
CMD_ARGS=(
  ...
  # scripts/ph14t/run_cognition_target_language.sh.
