...
#   scripts/ph14t/run_cognition_posenc.sh with visual_position_embedding_type=learned
...
#   for L in 4 8 12; do
#     python preprocess/ph14t/extract_scorer_features.py --backbone c_radio_v4 \
#       --backbone-config "{\"id\": \"nvidia/C-RADIOv4-SO400M\", \"output_layer\": -${L}}" \
#       --out dataset/ph14_scorer_features_L${L}
#     python preprocess/ph14t/train_scorer.py --features dataset/ph14_scorer_features_L${L} \
...
#     sbatch -J slt_ol${L} scripts/ph14t/run_cognition_outputlayer.sh ${L}
#   done
#
...
#   sbatch -J slt_ol-8_ep120 scripts/ph14t/run_cognition_outputlayer.sh -8 120
# --------------------------------------------------------------------------- #
...
# -8 -> L8. The per-layer scorer directory produced by preprocess/ph14t/train_scorer.py.
