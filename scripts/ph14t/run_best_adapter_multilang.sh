...
# =========================================================================== #
# USAGE
#   sbatch scripts/ph14t/run_best_adapter_multilang.sh [PROMPT_CONFIG] [EPOCHS]
#   bash scripts/ph14t/run_best_adapter_multilang.sh [PROMPT_CONFIG] [EPOCHS]
#
# Defaults: PROMPT_CONFIG=fixed_prompt, EPOCHS=20.
# PROMPT_CONFIG is the basename of a YAML file under configs/prompt/.
#
# Examples:
#   sbatch scripts/ph14t/run_best_adapter_multilang.sh
#   sbatch scripts/ph14t/run_best_adapter_multilang.sh diverse_train
#   sbatch scripts/ph14t/run_best_adapter_multilang.sh fixed_prompt_weather 25
#   scripts/ph14t/run_best_adapter_multilang.sh --help
# =========================================================================== #
