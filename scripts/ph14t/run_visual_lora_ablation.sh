...
# =========================================================================== #
# USAGE
#   sbatch [-J JOB_NAME] scripts/ph14t/run_visual_lora_ablation.sh [COUNT] [RANK] [EPOCHS] [debug] [share]
#   bash scripts/ph14t/run_visual_lora_ablation.sh [COUNT] [RANK] [EPOCHS] [debug] [share]
#
# Defaults: COUNT=2, RANK=8, ALPHA=2*RANK, LR=1e-3, EPOCHS=20.
# Example:  sbatch -J slt_vlora_n4_r16 scripts/ph14t/run_visual_lora_ablation.sh 4 16 30
# Help:     scripts/ph14t/run_visual_lora_ablation.sh --help
# =========================================================================== #
...
#
# Examples:
#   sbatch -J slt_vlora_n2_r8      scripts/ph14t/run_visual_lora_ablation.sh 2 8
#   sbatch -J slt_vlora_n4_r16     scripts/ph14t/run_visual_lora_ablation.sh 4 16
#   sbatch -J slt_vlora_n2_r8_ep50 scripts/ph14t/run_visual_lora_ablation.sh 2 8 50
#   bash scripts/ph14t/run_visual_lora_ablation.sh 2 8 debug share
# --------------------------------------------------------------------------- #
