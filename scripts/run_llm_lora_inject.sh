...
#
# Usage:
#   sbatch scripts/run_llm_lora_inject.sh <CKPT_DIR>                       # de, fixed prompt, r512, ep12
#   sbatch scripts/run_llm_lora_inject.sh <CKPT_DIR> 256                   # rank override
#   sbatch scripts/run_llm_lora_inject.sh <CKPT_DIR> 256 en                # single target language: de | en | zh
#   sbatch scripts/run_llm_lora_inject.sh <CKPT_DIR> multi                 # multilingual joint training (de+en+zh)
...
# --------------------------------------------------------------------------- #
# Generalizes scripts/run_llm_lora_ablation.sh (fixed ckpt96k checkpoint,
