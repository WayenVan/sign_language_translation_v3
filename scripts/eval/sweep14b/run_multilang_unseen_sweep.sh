...
#
# Usage:
#   bash scripts/eval/sweep14b/run_multilang_unseen_sweep.sh            # 已跑完 diverse 的每个 ckpt
#   bash scripts/eval/sweep14b/run_multilang_unseen_sweep.sh share      # 用仓库内数据集
#   bash scripts/eval/sweep14b/run_multilang_unseen_sweep.sh dry-run    # 只打印命令
#
# Environment:
...
#
# Help: scripts/eval/sweep14b/run_multilang_unseen_sweep.sh --help
#
...
if ((${#CHECKPOINTS[@]} == 0)); then
  ...
  echo "run scripts/eval/sweep14b/run_multilang_diverse_sweep.sh first." >&2
  exit 2
fi
