...
#
# Usage:
#   bash scripts/eval/sweep14b/run_multilang_counterfactual_sweep.sh            # 已跑完 diverse 的每个 ckpt
#   bash scripts/eval/sweep14b/run_multilang_counterfactual_sweep.sh share      # 用仓库内数据集
#   bash scripts/eval/sweep14b/run_multilang_counterfactual_sweep.sh dry-run    # 只打印命令
#
# Environment:
...
#
# Help: scripts/eval/sweep14b/run_multilang_counterfactual_sweep.sh --help
#
