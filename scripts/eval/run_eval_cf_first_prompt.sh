...
#
# Usage:
#   bash scripts/eval/run_eval_cf_first_prompt.sh <CKPT_DIR>          # 2 variants
#   bash scripts/eval/run_eval_cf_first_prompt.sh <CKPT_DIR> share    # in-repo dataset
#   bash scripts/eval/run_eval_cf_first_prompt.sh <CKPT_DIR> dry-run  # preview only
#
...
#
# Help: scripts/eval/run_eval_cf_first_prompt.sh --help
#
