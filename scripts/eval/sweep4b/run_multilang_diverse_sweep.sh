...
#
# Usage:
#   bash scripts/eval/sweep4b/run_multilang_diverse_sweep.sh            # 每个 run 里最好的 ckpt
#   bash scripts/eval/sweep4b/run_multilang_diverse_sweep.sh share      # 用仓库内数据集
#   bash scripts/eval/sweep4b/run_multilang_diverse_sweep.sh dry-run    # 只打印命令
#
# Environment:
...
#
# Help: scripts/eval/sweep4b/run_multilang_diverse_sweep.sh --help
#
