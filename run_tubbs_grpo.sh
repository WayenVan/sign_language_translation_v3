...
export WANDB_PROJECT=sign_language_translation_v3.0-rlhf
...
accelerate launch --num_processes=2 --mixed_precision=bf16 --debug -m csi_slt.commands.train_grpo \
  --config-name train/grpo \
